...
- [https://github.com/baal86/ttgf-analog-openschnapp/blob/main/docs/signal_processing/README.md](https://github.com/baal86/ttgf-analog-openschnapp/blob/main/docs/signal_processing/README.md)
...
The [overall simulation](https://github.com/baal86/ttgf-analog-openschnapp/blob/main/docs/total/README.md) shows example clock patters for correlated double sampling readout of the detector.
