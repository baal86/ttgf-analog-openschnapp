...
C {vsource.sym} 170 -360 0 1 {name=V2 value=3.3 savecurrent=false}
...
C {gnd.sym} 170 -320 0 1 {name=l3 lab=GND}
C {lab_wire.sym} 200 -400 0 1 {name=p1 sig_type=std_logic lab=VRESET}
