...
node="i(viref)
i(viload)"}
B 2 640 260 1440 660 {flags=graph
y1=1.2974164e-320
y2=2
ypos1=0
ypos2=2
...
T {Bias Current} 640 -230 0 0 0.4 0.4 {}
T {DC Transfer Function} 640 230 0 0 0.4 0.4 {}
...
value="
.control
	shell rm -f tb_pixel_nd2ps_dc.raw
	reset
	save currents
	save all
	dc V4 0.0 3.3 0.01
...
C {vsource.sym} 0 140 0 1 {name=V4 value=0.0 savecurrent=false}
