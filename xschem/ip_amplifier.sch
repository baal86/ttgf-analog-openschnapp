...
N 170 80 210 80 {lab=#net2}
N 250 -60 250 50 {lab=#net3}
N 250 -150 250 -120 {lab=#net4}
N 100 110 100 140 {lab=VSUBS}
N -30 -640 -30 -540 {lab=VDD}
N 100 -640 100 -540 {lab=VDD}
N 100 -480 100 -450 {lab=#net5}
N 100 -390 100 -320 {lab=#net6}
N 100 -640 380 -640 {lab=VDD}
N 900 -640 980 -640 {lab=VDD}
N 730 -640 730 -540 {lab=VDD}
N 900 -640 900 -540 {lab=VDD}
N 380 -250 380 -220 {lab=#net4}
N 380 -220 550 -220 {lab=#net4}
N 550 -250 550 -220 {lab=#net4}
N 250 -220 250 -210 {lab=#net4}
N 250 -220 380 -220 {lab=#net4}
N 300 -280 340 -280 {lab=INP}
N 590 -280 620 -280 {lab=INN}
N -30 -480 -30 -460 {lab=#net7}
...
N 100 -320 100 -260 {lab=#net6}
N 250 -210 250 -150 {lab=#net4}
N 380 -460 380 -430 {lab=DIFF_L}
N 550 -440 550 -390 {lab=DIFF_R}
N 730 -430 730 -420 {lab=DIFF_L}
N 900 -430 900 -420 {lab=DIFF_R}
N 900 -200 900 -140 {lab=#net9}
N 1110 -640 1160 -640 {lab=VDD}
N 1170 160 1180 160 {lab=VSUBS}
N -30 -120 -30 160 {lab=VSUBS}
N 730 -360 730 -310 {lab=#net10}
N 730 -250 730 -140 {lab=#net8}
N 900 -360 900 -310 {lab=#net11}
N 900 -250 900 -210 {lab=#net9}
N 380 -430 380 -390 {lab=DIFF_L}
N 380 -330 380 -310 {lab=#net12}
N 550 -330 550 -310 {lab=#net13}
N 900 -220 950 -220 {lab=#net9}
N 1010 -220 1080 -220 {lab=OUTP}
N -30 -210 -30 -180 {lab=#net14}
N -30 -460 -30 -450 {lab=#net7}
N 40 -510 40 -420 {lab=COM_P}
N 40 -420 60 -420 {lab=COM_P}
N 10 -420 40 -420 {lab=COM_P}
N -30 -390 -30 -270 {lab=COM_P}
N -30 -360 40 -360 {lab=COM_P}
N 40 -420 40 -360 {lab=COM_P}
N 100 -200 100 -120 {lab=#net2}
N 140 -90 210 -90 {lab=#net2}
N 100 -60 100 20 {lab=#net1}
N 170 -90 170 80 {lab=#net2}
N 170 -150 170 -90 {lab=#net2}
N 100 -150 170 -150 {lab=#net2}
N 680 -510 680 -390 {lab=COM_P}
N 680 -390 690 -390 {lab=COM_P}
N 850 -390 860 -390 {lab=COM_P}
N 850 -510 850 -390 {lab=COM_P}
...
C {res.sym} -30 -240 0 0 {name=R1
value=130k
footprint=1206
device=resistor
m=1}
C {ammeter.sym} -30 -150 0 0 {name=Vmeas savecurrent=false spice_ignore=0}
C {ammeter.sym} 100 -230 0 0 {name=Vmeas1 savecurrent=false spice_ignore=0}
C {ammeter.sym} 730 -280 0 0 {name=Vmeas2 savecurrent=false spice_ignore=0}
C {ammeter.sym} 900 -280 0 0 {name=Vmeas3 savecurrent=false spice_ignore=0}
C {ammeter.sym} 550 -360 0 0 {name=Vmeas4 savecurrent=false spice_ignore=0}
C {ammeter.sym} 380 -360 0 0 {name=Vmeas5 savecurrent=false spice_ignore=0}
C {capa.sym} 980 -220 1 0 {name=C1
m=1
value=1p
footprint=1206
device="ceramic capacitor"}
C {symbols/pfet3_03v3.sym} -10 -420 0 1 {name=M17
L=2.0u
W=10.0u
body=VDD
nf=1
...
C {symbols/nfet3_03v3.sym} 120 -90 0 1 {name=M18
L=2.0u
W=10u
body=VSUBS
nf=1
