...
N -170 -440 -170 -390 {lab=#net2}
N -170 -330 -170 -300 {lab=0}
N -170 -440 -70 -440 {lab=#net2}
N -10 -440 60 -440 {lab=#net1}
N 180 -540 370 -540 {lab=OUT}
N 40 -540 120 -540 {lab=#net1}
N 40 -540 40 -440 {lab=#net1}
N 40 -400 90 -400 {lab=#net3}
N 40 -400 40 -380 {lab=#net3}
N 40 -380 40 -370 {lab=#net3}
...
C {res.sym} -40 -440 1 0 {name=R1
value=10k
footprint=1206
device=resistor
m=1}
C {res.sym} 150 -540 1 0 {name=R2
value=30k
footprint=1206
device=resistor
m=1}
