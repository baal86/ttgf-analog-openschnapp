...
N -110 160 -110 190 {lab=#net3}
N -110 60 -110 100 {lab=#net4}
N -110 250 -110 260 {lab=#net6}
N -110 260 -110 280 {lab=#net6}
N -110 340 -110 390 {lab=vsubs}
N -130 40 -130 380 {lab=vsubs}
N -130 380 -130 390 {lab=vsubs}
...
C {symbols/ppolyf_u_1k_6p0.sym} -110 40 0 0 {name=R1
W=1e-6
L=6e-6
model=ppolyf_u_1k_6p0
spiceprefix=X
m=1}
C {symbols/ppolyf_u_1k_6p0.sym} -110 130 0 0 {name=R2
W=1e-6
L=6e-6
model=ppolyf_u_1k_6p0
spiceprefix=X
m=1}
C {symbols/ppolyf_u_1k_6p0.sym} -110 220 0 0 {name=R3
W=1e-6
L=6e-6
model=ppolyf_u_1k_6p0
spiceprefix=X
m=1}
C {symbols/ppolyf_u_1k_6p0.sym} -110 310 0 0 {name=R4
W=1e-6
L=6e-6
model=ppolyf_u_1k_6p0
spiceprefix=X
