...
F {}
E {}
B 2 -160 240 640 640 {flags=graph
y1=1.8
y2=2.3
ypos1=0
ypos2=2
...
N -160 40 -160 70 {lab=IN}
N -160 70 -160 90 {lab=IN}
...
C {vsource.sym} -160 120 0 0 {name=V2 value="PULSE(1.2 0.8 0.0 1n 1n 10u 20u)" savecurrent=false}
