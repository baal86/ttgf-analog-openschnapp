...
N 560 -140 560 -110 {lab=OUT}
N 560 -50 560 -10 {lab=0}
N 490 -140 490 -110 {lab=OUT}
...
N 490 -140 670 -140 {lab=OUT}
N 340 -140 490 -140 {lab=OUT}
N 280 -140 340 -140 {lab=OUT}
...
.endc
"}
C {vsource.sym} -360 50 0 0 {name=V2 value="PULSE(2.0 1.8 0.0 1n 1n 5u 10u)" savecurrent=false}
...
C {lab_wire.sym} 620 -140 0 0 {name=p4 sig_type=std_logic lab=OUT}
